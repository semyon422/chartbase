...
enums.ChannelEnum18Keys = {
	...
	-- CHANGED
	["D6"] = {name = "Note", inputType = "key", inputIndex = 8, mine = true},
	["D7"] = {name = "Note", inputType = "key", inputIndex = 9, mine = true},
	
	["E1"] = {name = "Note", inputType = "key", inputIndex = 10, mine = true},
	["E2"] = {name = "Note", inputType = "key", inputIndex = 11, mine = true},
	["E3"] = {name = "Note", inputType = "key", inputIndex = 12, mine = true},
	["E4"] = {name = "Note", inputType = "key", inputIndex = 13, mine = true},
	["E5"] = {name = "Note", inputType = "key", inputIndex = 14, mine = true},
	["E8"] = {name = "Note", inputType = "key", inputIndex = 15, mine = true},
	["E9"] = {name = "Note", inputType = "key", inputIndex = 16, mine = true},
	["E6"] = {name = "Note", inputType = "key", inputIndex = 17, mine = true},
	["E7"] = {name = "Note", inputType = "key", inputIndex = 18, mine = true},
}
